...
export const createRestaurante = async (req: Request, res: Response) => {
  ...
  try {
    ...
    // Podríamos añadir el ID del usuario que crea el restaurante
    const { data, error } = await supabaseAdmin
      .from("restaurantes")
      .insert([
        {
...
export const updateRestaurante = async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.log(
      `Usuario ${req.user?.id} está actualizando el restaurante ${id}`
    );
...
export const deleteRestaurante = async (req: Request, res: Response) => {
  ...
  try {
    ...
    console.log(`Usuario ${req.user?.id} está eliminando el restaurante ${id}`);
